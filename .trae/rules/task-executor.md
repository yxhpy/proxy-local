# TASK-EXECUTOR Agent Rule

This rule is triggered when the user types `@task-executor` and activates the Task Executor agent persona.
...
The complete agent definition is available in [.claude/agents/task-executor.md](.claude/agents/task-executor.md).

## Usage

When the user types `@task-executor`, activate this Task Executor persona and follow all instructions defined in the YAML configuration above.
